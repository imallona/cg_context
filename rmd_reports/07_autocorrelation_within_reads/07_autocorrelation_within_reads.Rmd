...
Within reads (with at least 5 events)
...
within <- within[within$cometh.n >= 5,]
```
...
print(rsq::rsq.partial(fit3, adj = TRUE))
```
...
Within reads (with at least 5 events in the genome)
