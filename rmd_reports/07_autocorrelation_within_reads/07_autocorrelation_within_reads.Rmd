...
## points(within$bg1.meth_prop.mean,  col = 'blue', pch = 19, cex = 0.5)
...
## points(within$bg2.meth_prop.mean, col = 'red', pch = 19, cex = 0.5)
...
legend('topright',
       legend=c("within strand cometh",
                "background meth (motifs separately)"),
       col=c("blue", "black"),
       lty= rep(1,2), pch = c(19, 4))
