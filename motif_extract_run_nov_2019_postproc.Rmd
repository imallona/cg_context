...
20190524.A-TBWGBS_A_R1.fastq.gz,20190524.A-TBWGBS_A,bwa_hiseq2500_se
20190524.A-TBWGBS_B_R1.fastq.gz,20190524.A-TBWGBS_B,bwa_hiseq2500_se
20190524.A-TBWGBS_K_R1.fastq.gz,20190524.A-TBWGBS_K,bwa_hiseq2500_se
20190524.A-TBWGBS_W_R1.fastq.gz,20190524.A-TBWGBS_W,bwa_hiseq2500_se",
...
for (context in names(outer)) {
    ...
    ##       geom_bar(position="dodge",stat="identity") +
    ##       scale_x_continuous(breaks = 1:8) +
    ##       facet_wrap(~nucleotide+id, ncol= length(unique(melted2$id))) +
    ##       xlab("position") +          
