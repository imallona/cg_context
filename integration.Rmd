...
# Data import
```{r data_import, include = TRUE, echo = TRUE, cache = TRUE}
...
```{r normalization, include = TRUE, echo = TRUE, cache = TRUE}
...
```{r purine_pyrimidine, include=TRUE, echo=TRUE, results='markup'}
...
```{r purine_pyrimidine, include=TRUE, echo=TRUE, results='markup', cache = TRUE}
