...
# Data import
```{r data_import, include = TRUE, echo = TRUE, cache = TRUE, cache.lazy = FALSE}
...
```{r normalization, include = TRUE, echo = TRUE, cache = TRUE, cache.lazy = FALSE}
...
```{r purine_pyrimidine,
include=TRUE, echo=TRUE, results='markup', cache = TRUE, cache.lazy = FALSE}
...
```{r sessionInfo, include=TRUE, echo=TRUE, results='markup', cache = TRUE, cache.lazy = FALSE}
...
for (ssample in unique(melted_six$sample)) {
    ...
    head(melted_six[
                ...
                melted_six[sprintf('idx%s', idx)] == nt, 'value'])
