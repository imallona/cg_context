...
SRR1274745,tko+d3b1,bwa_hiseq2k # @todo remove (tuncay told so)
...
SRR299062,stadler_es,bwa_gaiix_single', header = TRUE, sep = ',')
                                        # todo include qko from hiseq single ned
## https://www.ebi.ac.uk/arrayexpress/experiments/E-GEOD-57411/samples/?full=true
...
```{r test, include = FALSE, cache = TRUE, fig.width = 14, fig.height = 14}         
