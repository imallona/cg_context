...
Plotting the motifs sorted by their average score (CG context).
...
Getting the top percentile (q99) for variable motifs.
...
```{r logos, eval = FALSE, include = FALSE}
...
Variant plotting logos without any kind of normalization, just counting the events
